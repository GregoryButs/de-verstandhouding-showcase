...
> **Interactive Showcase**: Open [`[index.html](https://gregorybuts.github.io/de-verstandhouding-showcase/index.html)`](index.html) in any browser or visit the live deployment.
