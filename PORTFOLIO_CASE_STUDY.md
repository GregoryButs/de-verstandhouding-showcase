...
|  • 90%+ Geautomatiseerde Code Coverage (624 xUnit, 370 Vitest, 994 Tests Totaal)       |
...
| :--- | :--- | :--- | :--- |
| **Unit & Concurrency Tests** | xUnit / Moq | Domeinlogica, `SlotCalculator`, ELP teller, AES encryptie (59 bestanden) | 100% Pass (624 tests) |
...
| **Code Coverage** | Coverlet / ReportGenerator | Backend & Frontend gecombineerd (994 tests) | **> 90% Dekking** |
