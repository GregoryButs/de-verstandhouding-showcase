...
> * Behaalde **90%+ geautomatiseerde testdekking** (695 xUnit backend tests, 372 Vitest frontend tests — 1.067 tests totaal) met een complete GitHub Actions CI/CD pipeline.
...
> * Established **90%+ automated test coverage** across 695 xUnit tests, multi-threaded concurrency suites, and 372 Vitest tests (1.067 tests total) within a GitHub Actions CI/CD pipeline.
